// Python Level 2
const pythonLevel2 = {
    // Collision data for Python Level 2 (using same as original level2 for now)
    ...
    init: (spawnPosition) => {
        ...
        parsedCollisions = parse2D(pythonLevel2.collisionData, 32)
        ...
        // Create doors for Python Level 2
        doors = [
            new Sprite({
                position: {
                    x: 833,
